...
def parse_args():
    ...
    parser.add_argument('--iteration', type=int, default=202599, help='The number of images used in the train phase')
    parser.add_argument('--max_iteration', type=int, default=202599, help='The total number of images')
    ...
    parser.add_argument('--progressive', type=str2bool, default=False, help='use progressive training')
